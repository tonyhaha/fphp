...
<html lang="en"><head>
    <meta charset="utf-8">
    <title><?php echo $config["project"];?>--找回密码</title>
...
<div class="dialog">
    <div class="panel panel-default">
        <p class="panel-heading no-collapse">通过邮箱找回密码</p>
        <div class="panel-body">
            <!-- <form action="<?php echo $config['default_php']?>/user/findPwd" method="post" id="login-form"> -->
            <?php $post_url = $config['default_php'] . "/user/sendEmail"; ?>
            <form onsubmit="return hd_submit(this,'<?php echo $post_url ?>')" isPost=''>
                <div class="form-group">
                    <label>邮箱</label>
                    <input type="text" name="email" class="form-control span12" id="username">
                </div>
                <input type="submit" class="btn btn-primary pull-right" value="发送邮件" name="submit">
