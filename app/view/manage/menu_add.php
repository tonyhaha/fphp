    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10">
                ...
                <form class="form-horizontal" role="form" method="post" action="<?php echo $config['default_php']?>/manage/menu_add" id="reset-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <label class="radio-inline">
                                <input type="radio" name="type" value="1" checked=""> 权限菜单
                           </label>
                           <label class="radio-inline">
                                <input type="radio" name="type" value="2"> 普通菜单
                           </label>    
                        </div>
                    </div>
                    <div class="form-group">
